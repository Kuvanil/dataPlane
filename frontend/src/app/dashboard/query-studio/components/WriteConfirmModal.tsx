...
export default function WriteConfirmModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50" role="dialog" aria-modal="true">
      <div className="bg-zinc-900 border border-zinc-700 rounded-2xl p-6 max-w-md w-full flex flex-col gap-4">
        ...
        <div className="flex justify-end gap-2 mt-2">
          <button
            onClick={onCancel}
            className="px-4 py-2 text-sm bg-zinc-800 hover:bg-zinc-700 text-zinc-300 rounded-lg"
          >
            Cancel
          </button>
          <button
